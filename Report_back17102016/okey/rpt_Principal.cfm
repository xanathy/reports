...
<!---                 	<cfform action="../Consult/action.cfm?cr=1" id="formConsulta"> --->
                 	<cfform action="rpt_Gen.cfm?cr=1" id="formConsulta"> 
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-9">
                                <select id="tipoReporte" name="tipoReporte"> 
                                    ...
                                    <option value="2">Servicio social por profesi&oacute;n </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-10" style="margin-left:15px; margin-top:20px;">
							<label> <input type="checkbox" id="chkAddIap" name="chkAddIap"> Mostrar IAP donde se presta el servicio </label>
                        </div>
