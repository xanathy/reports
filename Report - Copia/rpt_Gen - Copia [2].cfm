                  ...
                  <div class="form-group-sm">
                    <div class="txtDetalle">
                        ...
                        <form action="rpt_GenPdf.cfm">
                            ...
                            <input type="hidden" id="rdPeriodo" name="rdPeriodo" value="#rdPeriodo#">
                            ...
                            <!---- a href="rpt_GenExcel.cfm?export=1&tipoReporte='#tipoReporte#'&rdEstatusSS='#rdEstatusSS#'&chkAddIap='#chkAddIap#'&fechainicio='#fechainicio#'&fechaFin='#fechaFin#'&rdPeriodo='#rdPeriodo#'">  --->
                        </form>
            	        
                        <img src="img/excel.png">Descargar</a>
                	    </div>
